...
<div class="space-y-8">
	<div>
		<h2 class="text-3xl font-bold tracking-tight">Add Property</h2>
		<p class="text-muted-foreground">Create a new device property</p>
	</div>
			...
			<div class="space-y-4">
				...
				<div class="space-y-2">
					...
					<p class="text-muted-foreground text-sm">
						A unique identifier for this property. Use lowercase letters, numbers, and hyphens only.
					</p>
				</div>
